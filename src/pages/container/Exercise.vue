    ...
    <div class="col-11custom">
      ...
      <div class="d-flex justify-content-around" style="flex-wrap:wrap; padding-top: 4%">
        ...
        <div class="card" style="width: 18rem;" v-for="(group, index) in groups" :key="index">
          <router-link  v-if="group.owner != username" :to="'/exStudent/' + group._id" style="text-decoration: none; color: inherit;" >
        ...
        <!-- </a> -->
         ...
         <router-link  v-else :to="'/exAdmin/' + group._id" style="text-decoration: none; color: inherit;">
